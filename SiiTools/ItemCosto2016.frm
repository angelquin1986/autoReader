...
Begin VB.Form frmItemCostos2016 
   BackColor       =   &H8000000A&
   Caption         =   "Costos"
   ClientHeight    =   4680
   ClientLeft      =   45
   ...
   Begin MSComctlLib.ImageList img1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":0114
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":0568
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":067C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":0790
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":0BE4
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":0E46
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":1B20
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":1F72
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":2084
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemCosto2016.frx":3906
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmItemCostos2016"
...
'    comodin = "%"
    ...
    sql = "select G.TRANSID, IDBODEGA, SUM(CANTIDAD) AS CANTIDAD, Idgrupo4"
    sql = sql & " Into TPE0"
    ...
    sql = " select G.TRANSID, IDBODEGA, SUM(CANTIDAD) AS PESOMP"
    sql = sql & " Into TPE1"
    sql = sql & " from gncomprobante g"
    sql = sql & " inner join ivkardex i"
    sql = sql & " inner join ivinventario iv"
    ...
    sql = " SELECT Idgrupo4, T0.IDBODEGA, SUM(PESOMP)*-1 as pesototal, (SUM(PESOMP)/SUM(CANTIDAD))*-1 AS PESO"
    sql = sql & " Into TPESO"
    ...
    VerificaExistenciaTablaTemp "tmp1"
     ...
     'sql = sql & " (SUM(PrecioRealTotal)/SUM(IVK.CANTIDAD)) AS PVP, "
     
'''     sql = sql & " CASE WHEN CHARINDEX ( 'BLOQUE',IV4.DESCRIPCION  ) = 1 THEN (SUM(PrecioRealTotal)/SUM(IVK.CANTIDAD))*12.25 "
'''    sql = sql & " WHEN CHARINDEX ( 'BORDILLO LIVIANO',IV4.DESCRIPCION  ) = 1 THEN (SUM(PrecioRealTotal)/SUM(IVK.CANTIDAD))*4.25 "
'''    sql = sql & " WHEN CHARINDEX ( 'BORDILLO PESADO',IV4.DESCRIPCION  ) = 1 THEN (SUM(PrecioRealTotal)/SUM(IVK.CANTIDAD))*1.44 "
'''    sql = sql & " Else "
'''    sql = sql & " (SUM(PrecioRealTotal)/SUM(IVK.CANTIDAD)) "
'''    sql = sql & " END AS PVP, "
     sql = sql & " IVI.IDGRUPO4,"
'     sql = sql & " CASE WHEN CHARINDEX ( 'BLOQUE',IV4.DESCRIPCION  ) = 1 THEN (SUM(IVK.CANTIDAD)/12.25)*-1"
'    sql = sql & " WHEN CHARINDEX ( 'BORDILLO LIVIANO',IV4.DESCRIPCION  ) = 1 THEN (SUM(IVK.CANTIDAD)/4.25)*-1"
'    sql = sql & " WHEN CHARINDEX ( 'BORDILLO PESADO',IV4.DESCRIPCION  ) = 1 THEN (SUM(IVK.CANTIDAD)/1.44)*-1"
'    sql = sql & " Else"
'    sql = sql & " Sum (ivk.CANTIDAD) * -1"
'    sql = sql & " END as CantTotal ,"
     ...
     'sql = sql & "case when len(max(CodAlterno2))=0 then MAX(pESONETO) else  MAX(pESONETO)* cast(max(CodAlterno2)as money )end   as PesoNeto "
 '    sql = sql & " max (pESONETO) as PesoNeto "
     sql = sql & " INTO TMP1 "
...
'    sql = sql & " END AS PVP, "
    ...
    gobjMain.EmpresaActual.EjecutarSQL sql, NumReg
     ...
     sql = sql & " isnull(A.PVP,0),ISNULL(A.PESO,B.PESO) AS PESO,isnull(a.pesoTotal, b.pesoTotal),0,0,0,0,0,0,0,0,  B.CantTotal, a.CantTotal ,A.precioTotal, "
