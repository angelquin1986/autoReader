...
Begin VB.Form frmRegeneraRecetas 
   ...
   End
End
Attribute VB_Name = "frmRegeneraRecetas"
...
Private Sub cmdBuscar_Click()
    ...
    End With
    Set obj = gobjMain.EmpresaActual.ConsGNTrans2SoloVentas(True) 'Ascendente     '*** MAKOTO 20/oct/00
    If Not obj.EOF Then
        v = MiGetRows(obj)
...
'    grd.Move 0, grd.Top, Me.ScaleWidth, (Me.ScaleHeight - grd.Top - pic1.Height - 80)
    ...
    grdIvk.Move 0, grd.Top + grd.Height, Me.ScaleWidth / 2, (Me.ScaleHeight - grd.Top - pic1.Height - 80) / 4
    
    grdIvkn.Move 0, grd.Top + grd.Height + grdIvk.Height, Me.ScaleWidth / 2, (Me.ScaleHeight - grd.Top - pic1.Height - 80) / 4

    grdVenta.Move grd.Left + grd.Width, grd.Top, Me.ScaleWidth / 2, (Me.ScaleHeight - grd.Top - pic1.Height - 80) / 4
