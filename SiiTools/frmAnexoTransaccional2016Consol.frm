...
Begin VB.Form frmAnexoTransaccional2016Consol 
   ...
   Begin VSFlex7LCtl.VSFlexGrid grd 
      ...
      FormatString    =   $"frmAnexoTransaccional2016Consol.frx":0000
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VB.Frame frmfecha 
      ...
      Begin VB.ComboBox cboTipo 
         Height          =   315
         ItemData        =   "frmAnexoTransaccional2016Consol.frx":0063
         Left            =   840
         List            =   "frmAnexoTransaccional2016Consol.frx":006D
         TabIndex        =   1
         Top             =   240
         Width           =   2235
      End
   ...
   Begin VSFlex7LCtl.VSFlexGrid grdCF 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmAnexoTransaccional2016Consol.frx":008C
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex7LCtl.VSFlexGrid grdRet 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmAnexoTransaccional2016Consol.frx":00EF
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex7LCtl.VSFlexGrid GrdRetVentas 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmAnexoTransaccional2016Consol.frx":0152
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
      ...
      WallPaperAlignment=   9
   End
   Begin VSFlex7LCtl.VSFlexGrid grdSucursal 
      Height          =   1995
      Left            =   13320
      TabIndex        =   42
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmAnexoTransaccional2016Consol"
...
Private SucursalSelec As String
 ...
 Public Sub Inicio2016(ByVal tag As String)
    ...
    ConfigColsEmpresas
    SucursalSelec = ""
    If Len(gobjMain.EmpresaActual.GNOpcion.ObtenerValor("ATS2016_Sucursales")) > 0 Then
        SucursalSelec = gobjMain.EmpresaActual.GNOpcion.ObtenerValor("ATS2016_Sucursales")
    End If
    RecuperarEmpSeleccionadas
    TotalVentas = 0
    dtpPeriodo.value = CDate("01/" & IIf(Month(Date) - 1 <> 0, Month(Date) - 1, 12) & "/" & Year(Date))
    mObjCond.fecha1 = dtpPeriodo.value
    cboTipo.ListIndex = 0
    If Len(gobjMain.EmpresaActual.GNOpcion.ObtenerValor("ATS2016_RutaATS")) > 0 Then
        txtCarpeta.Text = gobjMain.EmpresaActual.GNOpcion.ObtenerValor("ATS2016_RutaATS")
    End If
    Me.tag = tag
    Me.Show
    Exit Sub
...
Private Sub cmdPasos_Click(Index As Integer)
    Dim r As Boolean, cad As String, nombre As String, file As String, CadEmp As String
    NumProc = Index + 1
    ...
    Case 1      '1. Busca Compras
        CadEmp = ListadoEmpresasSeleccionadas
        gobjMain.EmpresaActual.GNOpcion.AsignarValor "ATS2016_Sucursales", CadEmp
        gobjMain.EmpresaActual.GNOpcion.GrabarSoloGnOpcion2
        SucursalSelec = CadEmp
        BuscarComprasATS
        cadCompras = ""
    ...
    Case 11      '8. Generar Archivo
        If cboTipo.ListIndex = 0 Then
            ...
            gobjMain.EmpresaActual.GNOpcion.AsignarValor "ATS2016_RutaATS", txtCarpeta.Text
            gobjMain.EmpresaActual.GNOpcion.GrabarSoloGnOpcion2
...
Private Sub BuscarComprasATS()
    ...
    On Error GoTo ErrTrap
        ...
        .Redraw = False
        .Rows = .FixedRows
        'cad = ListadoEmpresasSeleccionadas
        If Not frmB_TransConsol.Inicio(gobjMain, "IMPCPI2016", dtpPeriodo.value, SucursalSelec) Then
            grd.SetFocus
        End If
        mObjCond.fecha1 = gobjMain.objCondicion.fecha1
        mObjCond.fecha2 = gobjMain.objCondicion.fecha2
        MiGetRowsRep gobjMain.EmpresaActual.Empresa2.ConsANCompras2016ConsolParaXML(SucursalSelec), grd
...
Private Sub ConfigCols(cad As String)
    ...
    Select Case cad
    Case "IMPCPI"           'Compras
        s = "^#|TransId|^Fecha|^FechaReg|<CodTrans|<Num|^Doc.|idproveedorref|<RUC|<Proveedor|<Rel.|^Estab|^Punto|^Secuencial|>AutSRI|^Caducidad|^Sustento|^TipoComp|^Tipo Pago|^Pago Exterior|>CodPaisSRI  |^BandDobleTributa |^BandPagoSujRet|>Base Cero|>Base IVA|>Base NO IVA|<Cod ICE|>Val ICE|^BANDREToTRO|>IVA|>Tipo Prov|<Empresa|<Ret"
...
'                            Set pc = gobjMain.EmpresaActual.RecuperaPCProvCliQuick(CDbl(grd.TextMatrix(i, COL_C_IDPROV)))
 '                           cadenaTipoProv = cadenaTipoProv & "<parteRel>" & IIf(pc.BandRelacionado, "SI", "NO") & "</parteRel>"
                    ...
                    Case "P":
                        ...
                        If grd.TextMatrix(i, COL_C_IDPROV) = "RPN" Then
                            cadenaTipoProv = cadenaTipoProv & "<tipoProv> 01 </tipoProv>"
                        ElseIf grd.TextMatrix(i, COL_C_IDPROV) = "RSO" Then
          ...
          '      If grd.TextMatrix(i, COL_C_CODTIPOCOMP) <> "41" Then
                ...
                Set rsRet = gobjMain.EmpresaActual.Empresa2.ConsANRetencionComprasConsolidadas2016ParaXML(grd.ValueMatrix(i, COL_C_TRANSID), grd.TextMatrix(i, COL_C_EMP), grd.TextMatrix(i, COL_C_RET))
...
'                    Set rsRet = gobjMain.EmpresaActual.ConsANRetencionCompras2008ParaXMLSinRetencion(grd.ValueMatrix(i, COL_C_TRANSID))
                    Set rsRet = gobjMain.EmpresaActual.Empresa2.ConsANRetencionComprasConsolidadas2016ParaXMLSinRetencion(grd.ValueMatrix(i, COL_C_TRANSID), grd.TextMatrix(i, COL_C_EMP))
...
Private Function BuscarVentasATS()
    ...
    On Error GoTo ErrTrap
        ...
        If Not frmB_TransConsol.Inicio(gobjMain, "IMPFC2016", dtpPeriodo.value, SucursalSelec) Then
            grd.SetFocus
        End If
        mObjCond.fecha1 = gobjMain.objCondicion.fecha1
        mObjCond.fecha2 = gobjMain.objCondicion.fecha2
'        MiGetRowsRep gobjMain.EmpresaActual.Empresa2.ConsANVentas2016paraXML(), grd
        MiGetRowsRep gobjMain.EmpresaActual.Empresa2.ConsANVentas2016ConsolParaXML(SucursalSelec), grd
...
Private Function BuscarANuladosATS()
    On Error GoTo ErrTrap
        ...
        If Not frmB_TransConsol.Inicio(gobjMain, "IMPAN2016", dtpPeriodo.value, SucursalSelec) Then
            grd.SetFocus
        End If
        mObjCond.fecha1 = gobjMain.objCondicion.fecha1
        mObjCond.fecha2 = gobjMain.objCondicion.fecha2
        MiGetRowsRep gobjMain.EmpresaActual.ConsANComprobantesAnulado2008ParaXML(), grd
        MiGetRowsRep gobjMain.EmpresaActual.Empresa2.ConsANAnuladosConsolidadas2016paraXML(SucursalSelec), grd
...
Private Function BuscarVentasEstablecimientoATS()
    On Error GoTo ErrTrap
        ...
        .Redraw = False
        .Rows = .FixedRows
        If Not frmB_TransConsol.Inicio(gobjMain, "IMPFC2016xE", dtpPeriodo.value, SucursalSelec) Then
            grd.SetFocus
        End If
        mObjCond.fecha1 = gobjMain.objCondicion.fecha1
        mObjCond.fecha2 = gobjMain.objCondicion.fecha2
        'MiGetRowsRep gobjMain.EmpresaActual.ConsANVentasxEstablecimiento2013paraXML(), grd
        MiGetRowsRep gobjMain.EmpresaActual.Empresa2.ConsANVentasConsolidadasxEstablecimiento2016paraXML(SucursalSelec), grd
...
Private Sub ConfigColsEmpresas()
    With grdSucursal
...
Private Function ListadoEmpresasSeleccionadas() As String
Dim i As Integer, cad As String
    ListadoEmpresasSeleccionadas = ""
    For i = 1 To grdSucursal.Rows - 1
        If grdSucursal.TextMatrix(i, COLS_SEL) <> 0 Then
            cad = cad & grdSucursal.TextMatrix(i, 1) & "," & grdSucursal.TextMatrix(i, 3) & ";"
        End If
    Next i
    If Len(cad) > 0 Then
        ListadoEmpresasSeleccionadas = Mid$(cad, 1, Len(cad) - 1)
    End If

End Function

Private Sub RecuperarEmpSeleccionadas()
    Dim Cadena As String, i As Integer, j As Integer, v As Variant, W As Variant


    'Recupera las empresas Sucursales
    Cadena = SucursalSelec
    ...
    For i = LBound(W) To UBound(W)
        For j = 1 To grdSucursal.Rows - 1
            v = Split(W(i), ",")
            If grdSucursal.TextMatrix(j, COLS_NOM) = v(1) Then
