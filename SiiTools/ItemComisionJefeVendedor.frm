...
Begin VB.Form frmComisionesJefeVendedor 
   Caption         =   "Actualización de Comisiones y Penalizaciones por Jefe de Ventas"
   ClientHeight    =   4680
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   6240
   ...
   Begin MSComctlLib.ImageList img1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemComisionJefeVendedor.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemComisionJefeVendedor.frx":0114
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemComisionJefeVendedor.frx":0568
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemComisionJefeVendedor.frx":067C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ItemComisionJefeVendedor.frx":0790
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmComisionesJefeVendedor"
...
'IVINVENTARIO
Const COL_TOTAL = 7
Const COL_COMIVEN = 15
Const COL_COMICOB = 16
Const COL_COMITOTAL = 17
...
'        ' costo real por total
        ...
        sql = "SELECT  FCVendedor.Nombre, tipoTabla, " & _
        ...
        sql = sql & "WHERE  " & cond & _
              ...
              "GNComprobante.NumDocRef, PCProvCli.Nombre, GNComprobante.TransID, tipoTabla "
...
Private Sub ConfigCols()
    ...
    Select Case Me.tag
        Case "COMI"
            s = "^#|<Vendedor|<TipoTabla|<Cliente|<TransID|<Transacción|<Fecha Emision|>Venta Neta|>rec0|>rec1|>rec2|>rec3|>rec4|>rec5|>rec6|>Comisión Vendedor|>Comisión Cobrador|>Total Comisión|>Resultado"
        End Select
        .FormatString = s
        ...
        If Not objcond Is Nothing Then
            ...
            max = UBound(v, 1)
            s = "^#|<Vendedor|<TipoTabla|<Cliente|<TransID|<Transacción|<Fecha Emision|>Venta Neta"
            For i = 0 To max
                s = s & "|>" & v(i)
                grd.ColHidden(i + 8) = False
            Next i
            For i = max + 1 To 6
               s = s & "|>Rec" & i
               grd.ColHidden(i + 8) = True
            Next i
            .FormatString = s
            CalculaSubtotal
        End If
...
Dim band As Boolean
    ...
    For i = 1 To grd.Rows - 1
        ...
        If grd.IsSubtotal(i) = True Then
            If grd.TextMatrix(i - 1, 2) = "1" Then
                For j = 1 To 10
                    If grd.TextMatrix(i, COL_TOTAL) >= gComisiones(j).desde And grd.TextMatrix(i, COL_TOTAL) <= gComisiones(j).hasta Then
                        For k = m To i - 1
                            grd.TextMatrix(k, COL_COMIVEN) = gComisiones(j).Comision * gConfigura.PorcenVendedorA / 100
                            grd.TextMatrix(k, COL_COMICOB) = gComisiones(j).Comision * gConfigura.PorcenCobradorA / 100
                ...
                If band Then
                    ...
                    band = False
                End If
            ElseIf grd.TextMatrix(i - 1, 2) = "2" Then
                For j = 1 To 10
                ...
                If band Then
                    ...
                    band = False
                End If
            ElseIf grd.TextMatrix(i - 1, 2) = "3" Then
                For j = 1 To 10
                ...
                If band Then
                    ...
                    band = False
                End If
            ElseIf grd.TextMatrix(i - 1, 2) = "4" Then
                For j = 1 To 10
...
Private Sub CalculaSubtotal()
    ...
    For i = 1 To grd.Rows - 1
            ...
            If Not grd.IsSubtotal(i) = True Then
                For j = 0 To max
                    If Len(grd.TextMatrix(i, 7 + j)) > 0 Then
                        tot = tot + grd.TextMatrix(i, 7 + j)
                    End If
                Next j
