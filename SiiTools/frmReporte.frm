   ...
   Begin MSComctlLib.ImageList imlLista 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmReporte.frx":0114
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmReporte.frx":0228
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmReporte.frx":033C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmReporte.frx":0450
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmReporte.frx":0564
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmReporte.frx":0678
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmReporte.frx":0CF4
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmReporte.frx":1148
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub CargarResumenVentas()
    ...
    If fecha1 <> 0 Or fecha2 <> 0 Then
        If Bandfirst Then Cond = Cond & " AND "
        Cond = Cond & "(fecha BETWEEN " & FechaYMD(fecha1, mobjSMain.EmpresaActual.TipoDB, False) & _
                      " and " & FechaYMD(fecha2, mobjSMain.EmpresaActual.TipoDB, False) & ")"
        Bandfirst = True
    End If
...
Private Sub CargarFormulario101()
    ...
    sql = sql & "and  (fechatrans BETWEEN " & FechaYMD(fecha1, mobjSMain.EmpresaActual.TipoDB, False) & _
                    " and " & FechaYMD(fecha2, mobjSMain.EmpresaActual.TipoDB, False) & ")"
    ...
    grd.Redraw = flexRDNone
    Set rs = mobjSMain.EmpresaActual.OpenRecordset(sql)
    MiGetRowsRep rs, grd
