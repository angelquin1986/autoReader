...
Begin VB.Form frmReprocCostoISO 
   ...
   End
End
Attribute VB_Name = "frmReprocCostoISO"
...
'        'Solo de salida
            ...
            If Not (item Is Nothing) Then
                ...
                End If
                '*** MAKOTO 08/dic/00
                If gnc.GNTrans.CodPantalla = "IVISOFAC" And Not gnc.GNTrans.IVTransProd Then
                    FechaIngreso = gnc.Empresa.ObtieneCampoDetalleTicket(ivk.TiempoEntrega, "FechaTrans")
                    If FechaIngreso > gnc.Empresa.GNOpcion.ObtenerValor("FechaListaPrecios") Then
                    ...
                    End If
                ElseIf gnc.GNTrans.CodPantalla = "IVISOPRD" And gnc.GNTrans.IVTransProd Then
                    'REVISA CONSUMOS
                    For k = 1 To ivk.NumFamiliaDetalle
                    Set CONSUMO = ivk.RecuperaConsumoDetalle(k)
                    Set ITEMCONS = gnc.Empresa.RecuperaIVInventario(CONSUMO.CodInventario)
                    ct = ITEMCONS.CostoDouble2(gnc.FechaTrans, _
                                           Abs(ivk.cantidad), _
                                           gnc.TransID, _
                                           gnc.HoraTrans)
