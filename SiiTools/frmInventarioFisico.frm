...
Begin VB.Form frmInventarioFisico 
   ...
   Begin MSComctlLib.ImageList img1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInventarioFisico.frx":0054
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInventarioFisico.frx":0166
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInventarioFisico.frx":05B8
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInventarioFisico.frx":06CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInventarioFisico.frx":07DC
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VSFlex7LCtl.VSFlexGrid grdMsg 
      ...
      FormatString    =   $"frmInventarioFisico.frx":10B6
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
...
Private Sub cmdProcesar_Click()
    ...
    If gobjMain.EmpresaActual.GNOpcion.IVKTipoDatoDouble Then
        IVAjuste.VisualizaDesdeObjetoDou
        IVBaja.VisualizaDesdeObjetoDou
    Else
    ...
    If Not (mBandRevisarNoContados) Then
        If MsgBox("Desea agregar los items con existencia y que no han sido contados fisicamente", vbYesNo) = vbYes Then
            ...
            If gobjMain.EmpresaActual.GNOpcion.IVKTipoDatoDouble Then
                ...
                IVFisico.VisualizaDesdeObjetoDou
            Else
                IVFisico.CargarItemsNoContados
...
Private Sub dtpFecha_Change()
    If Not mobjGNComp_CF Is Nothing Then
        mobjGNComp_CF.FechaTrans = dtpFecha.value
    End If
End Sub
...
Private Sub Procesar()
    ...
    Dim i As Long, signo As Integer, cant As Currency
    ...
    For i = 1 To IVFisico.GNComprobante.CountIVKardex
        ...
        If dif > 0 Then
            With IVAjuste
                ...
                cant = dif
                If gobjMain.EmpresaActual.GNOpcion.IVKTipoDatoDouble Then
                    .GNComprobante.IVKardex(ix).cantidadDou = cant
                Else
                ...
                End If
                If gobjMain.EmpresaActual.GNOpcion.IVKTipoDatoDouble Then
                    .GNComprobante.IVKardex(ix).CostoTotalDou = c * cant
                Else
