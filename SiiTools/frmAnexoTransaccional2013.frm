...
Begin VB.Form frmAnexoTransaccional2013 
   Caption         =   "dlg1"
   ClientHeight    =   7845
   ClientLeft      =   45
   ClientTop       =   345
   ...
   Begin VB.Frame frmfecha 
      ...
      Begin VB.ComboBox cboTipo 
         Height          =   315
         ItemData        =   "frmAnexoTransaccional2013.frx":0000
         Left            =   840
         List            =   "frmAnexoTransaccional2013.frx":000A
         TabIndex        =   1
         Top             =   240
         Width           =   2235
      End
   ...
   Begin VSFlex7LCtl.VSFlexGrid grd 
      ...
      FormatString    =   $"frmAnexoTransaccional2013.frx":0029
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex7LCtl.VSFlexGrid grdRet 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmAnexoTransaccional2013.frx":008C
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex7LCtl.VSFlexGrid grdCF 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmAnexoTransaccional2013.frx":00EF
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex7LCtl.VSFlexGrid GrdRetVentas 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmAnexoTransaccional2013.frx":0152
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmAnexoTransaccional2013"
...
Private Sub BuscarComprasATS()
    ...
    On Error GoTo ErrTrap
        ...
        MiGetRowsRep gobjMain.EmpresaActual.ConsANCompras2013ParaXML(), grd
...
Private Sub ConfigCols(cad As String)
    ...
    Select Case cad
    Case "IMPCPI"           'Compras
        s = "^#|TransId|^Fecha|^FechaReg|<CodTrans|<Num|^Doc.|idproveedorref|<RUC|<Proveedor|^Estab|^Punto|^Secuencial|>AutSRI|^Caducidad|^Sustento|^TipoComp|^Tipo Pago|^Pago Exterior|>CodPaisSRI  |^BandDobleTributa |^BandPagoSujRet|>Base Cero|>Base IVA|>Base NO IVA|<Cod ICE|>Val ICE|^BANDREToTRO"
    ...
    Case "IMPFC"
        ...
        s = "^#|<Fecha|^Doc|<IdProvcli|<RUC|<Cliente|^Tipo Comp|^Cant Trans |>Base 0|>Base IVA|>Base NO IVA|>Valor IVA "
        grd.FormatString = s & "|<         Resultado           "
        AsignarTituloAColKey grd
    ...
    Case "IMPEX"
        ...
        s = "^#|<RUC|<Cliente|^Referendo|^Tipo Comp|<Distrito|<Anio|<Regimen|<Correlativo|<Doc. Transporte|<Fecha Embarque|>Valor FOB|>Valor FOB Local|>Establecimiento|>Punto|>Secuencial|>Autorizacion|Fecha Trans|>Valor Factura "
        grd.FormatString = s & "|<         Resultado           "
        AsignarTituloAColKey grd
...
Private Function GeneraArchivoATSComprasXML(ByRef cad As String) As Boolean
    ...
    Dim CadenaRGasto As String, rsRG As Recordset, contRG As Integer
    ...
    'With grd
        ...
        cadenaCP = "<compras>"
            ...
            For i = 1 To grd.Rows - 1
                ...
                cadenaCP = cadenaCP & "<montoIva>" & Format(IIf(Abs(grd.ValueMatrix(i, COL_C_BASE12)) = 0, "0.00", Abs(grd.ValueMatrix(i, COL_C_BASE12)) * 0.12), "#0.00") & "</montoIva>"
          ...
          '      If grd.TextMatrix(i, COL_C_CODTIPOCOMP) <> "41" Then
                ...
                If (Abs(grd.ValueMatrix(i, COL_C_BASE12)) + Abs(grd.ValueMatrix(i, COL_C_BASE0)) + Abs(grd.ValueMatrix(i, COL_C_BASENO12)) + Abs(grd.ValueMatrix(i, COL_C_BASE12) * 0.12)) > "999.99" And grd.TextMatrix(i, COL_C_CODTIPOCOMP) <> "4" Then
...
Private Function BuscarExportacionesATS()
    On Error GoTo ErrTrap
        ...
        mObjCond.fecha1 = gobjMain.objCondicion.fecha1
        mObjCond.fecha2 = gobjMain.objCondicion.fecha2
        MiGetRowsRep gobjMain.EmpresaActual.ConsANExportacion2013paraXML(), grd
