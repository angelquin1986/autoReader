...
Public gConfig As T_CONFIG      'configuraciones para importar en las ventas d locutorios
...
''    Unload frmSplash
    ...
    If Not frmLogin.Inicio Then End
    Unload frmLogin
...
Public Sub CargarCatalogos( _
    ...
    With grd
        ...
        '**** jeaa 08/04/2011
'        .AddItem .Rows & vbTab & "IVDescuento" & vbTab & "IVD"
'        .AddItem .Rows & vbTab & "IVDescuentoDetalleFC" & vbTab & "IVDDFC"
'        .AddItem .Rows & vbTab & "IVDescuentoDetalleIV" & vbTab & "IVDDIV"
'        .AddItem .Rows & vbTab & "IVDescuentoDetallePC" & vbTab & "IVDDPC"
'
'        .AddItem .Rows & vbTab & "IVPromocion" & vbTab & "IVP"
'        .AddItem .Rows & vbTab & "IVCondPromocionDetalle" & vbTab & "IVCPD"
'        .AddItem .Rows & vbTab & "IVCondPromocionDetalleIVG" & vbTab & "IVCPDI"
'        .AddItem .Rows & vbTab & "IVCondPromocionDetalleP" & vbTab & "IVCPDP"
'        .AddItem .Rows & vbTab & "GNZona" & vbTab & "GNZ"
'        .AddItem .Rows & vbTab & "GNObra" & vbTab & "GNO"
...
Public Sub RecuperarConfig()
    With gConfigura
        .Archivo = GetSetting(APPNAME, SECTION, "Archivo", "C:\Archivos de Programa\Sii4A\TablaComisiones.txt")
...
Public Sub CargaTipoTransxTipoTrans(ByRef Modulo As String, ByRef lst As ListBox, TipoTrans As String)
    ...
    numMod = UBound(Vector, 1)
    If numMod = -1 Then
        Set rs = gobjMain.EmpresaActual.ListaGNTransTipoTRans("", False, True, TipoTrans)
        With rs
            If Not (.EOF) Then
                .MoveFirst
                Do Until .EOF
