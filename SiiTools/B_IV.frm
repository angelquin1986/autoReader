...
Begin VB.Form frmB_IV 
   ...
   Begin TabDlg.SSTab sst1 
      ...
      TabPicture(1)   =   "B_IV.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "lblEtiqGrupo5"
      Tab(1).Control(1)=   "lblEtiqGrupo4"
      Tab(1).Control(2)=   "lblEtiqGrupo3"
      Tab(1).Control(3)=   "lblEtiqGrupo2"
      Tab(1).Control(4)=   "lblEtiqGrupo1"
      Tab(1).Control(5)=   "fcbGrupo5"
      Tab(1).Control(6)=   "fcbGrupo4"
      Tab(1).Control(7)=   "fcbGrupo3"
      Tab(1).Control(8)=   "fcbGrupo2"
      Tab(1).Control(9)=   "fcbGrupo1"
...
Public Function Inicio(ByRef CodAlt As String, _
    ...
    With objcond
        If Formulario <> "Exis" And Formulario <> "ConsIVExistVol" Then
...
Public Function InicioBuffer(ByRef CodAlt As String, _
                       ByRef Desc As String, _
                       ByRef CodBodega As String, _
                       ByVal Formulario As String, _
                       ByRef objcond As RepCondicion) As Boolean
    ...
    chkGrupos.value = IIf(SeleccionAnterior = "S", vbChecked, vbUnchecked)
    chkGrupos_Click
    chkExistencia.Caption = "Prom Vta Catalogo"
    lblFechaHasta.Visible = True
    dtpFechaHasta.Visible = True
    
    With objcond
        dtpFecha.value = IIf(.fecha1 = 0, Date, .fecha1)
